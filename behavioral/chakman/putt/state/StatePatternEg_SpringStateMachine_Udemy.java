...
public class StatePatternEg_SpringStateMachine_Udemy {
	public static void main(String[] args) throws Exception {
		// get machine/ build machine
		...
		// running our machine
		while(true) {   // infinite loop exists till exitState is hit
	...
	// our state machine build in a function
